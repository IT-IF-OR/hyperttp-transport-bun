import { fastGetHostname, getAbortError, EMPTY_HEADERS, normalizeHeaders, resolveUrl, TIMEOUT_ERROR, } from "./utils/helpers.js";
...
export class BunTransport {
    ...
    storeCookies(requestUrl, headers) {
        if (!this.cookiesEnabled || typeof headers.getSetCookie !== "function")
            return;
